    ...
    <div>
        <div class="d-lg-none mb-10">
            <v-row>
                ...
                <v-img alt="Vuetify Name" v-if="settings.screenSize.type.isxs" contain src="../assets/logomepa.png"
                    width="100%" max-width="15%" />
                <v-spacer></v-spacer>
                <template>
                    <div class="my-5">
            ...
            <v-card v-else class="mx-auto" max-width="400" tile>
                ...
                <v-list shaped>
                    ...
                    <v-list-item-group v-model="selectedItemRole" color="primary">
                        ...
                        <v-list-item v-else @change="getRole(item)" v-for="(item, i) in listDataRiwajatRole" :key="i">
                            <v-list-item-icon>
